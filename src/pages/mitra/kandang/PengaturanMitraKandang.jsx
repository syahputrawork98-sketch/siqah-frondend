...
export default function PengaturanMitraKandang() {
  ...
  useEffect(() => {
    ...
    setMitraData({
      username: "kandang_a",
      email: "mitrakandang@siqah.com",
      nama_mitra: "Ahmad Fauzi",
      no_telp: "081356789012",
      alamat: "Kandang A, Desa Mekarjaya, Bandung",
      foto: "/images/mitra-kandang.jpg",
    });
  }, []);

  const handleChange = (e) => {
    const { name, value } = e.target;
    setMitraData((prev) => ({ ...prev, [name]: value }));
  };
  ...
  const handleSubmit = (e) => {
    ...
    // Integrasi backend dilakukan saat endpoint mitra-kandang final tersedia.
  };
    ...
    <div className="p-6 space-y-8">
      ...
      <div>
        <h1 className="text-2xl font-semibold text-[#3b3b3b] mb-2">
          Pengaturan Mitra Kandang
        </h1>
        <p className="text-sm text-[#7a7368]">
          Kelola informasi akun dan profil mitra kandang Anda.
        </p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder="contoh: mitra@siqah.com"
                  className="w-full border border-[#eee6da] rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-[#e2b97f]"
                />
              </div>
              <div>
