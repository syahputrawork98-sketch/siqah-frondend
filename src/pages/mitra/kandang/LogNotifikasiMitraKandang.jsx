...
export default function LogNotifikasiMitraKandang() {
  ...
  useEffect(() => {
    // Data dummy sementara (mengacu pada struktur tb_notifikasi_mitra)
    setNotifikasi([
      {
        id_notifikasi: 1,
    ...
    <div className="p-6 space-y-10">
      ...
      <div>
        <h1 className="text-2xl font-semibold text-[#3b3b3b] mb-2">
          Log Notifikasi Mitra Kandang
        </h1>
        <p className="text-sm text-[#7a7368]">
          Riwayat semua notifikasi sistem yang dikirim kepada Anda sebagai mitra kandang.
        </p>
      </div>
