...
export default function DashboardMitraKandang() {
    ...
    <div className="space-y-6">
      ...
      <div>
        <h2 className="text-xl font-semibold text-[#3b3b3b] tracking-wide">
          Selamat Datang,{" "}
          <span className="text-[#e2b97f]">Mitra Kandang Siqah</span>
        </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-5">
        ...
        />
        <StatCard icon={Users} title="Mitra Aktif" value={data.mitraAktif} />
      </div>
