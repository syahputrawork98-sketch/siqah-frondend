...
export default function TopbarMitraKandang() {
  ...
  const mitra = {
    ...
    avatar:
      "https://ui-avatars.com/api/?name=Mitra+Kandang&background=e2b97f&color=fff",
  };
    ...
    >
      ...
      <div>
        <h2 className="text-lg font-semibold text-[#3b3b3b] tracking-wide">
          Panel <span className="text-[#e2b97f]">Mitra Kandang</span>
        </h2>
      </div>
      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-3 bg-white/60 rounded-full px-3 py-1 border border-[#eee6da] shadow-sm">
          ...
          <div className="hidden sm:block">
            <p className="text-sm font-medium text-[#3b3b3b]">{mitra.name}</p>
            <p className="text-xs text-[#7a7368]">{mitra.email}</p>
          </div>
        </div>
